                    ...
                    if(($document->getCategory() === $category->getName()) && ($document->getItem() === "exo")) {
                        ...
                        <div class="section_documents">
                            <div class="section_documents_item">
                                <div class="section_documents_item_tittle"><a class="linkDoc" href="" data-href="<?= $document->getLink()?>" data-type="exo" target="_blank"><i class="fab fa-github"></i> <?= $document->getTitle()?></a></div>
